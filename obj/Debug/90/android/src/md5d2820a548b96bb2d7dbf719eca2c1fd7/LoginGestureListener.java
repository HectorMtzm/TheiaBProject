...
public class LoginGestureListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TheiaBProjectv2.Listeners.LoginGestureListener, TheiaBProjectv2", LoginGestureListener.class, __md_methods);
	}


	public LoginGestureListener ()
	{
		super ();
		if (getClass () == LoginGestureListener.class)
			mono.android.TypeManager.Activate ("TheiaBProjectv2.Listeners.LoginGestureListener, TheiaBProjectv2", "", this, new java.lang.Object[] {  });
	}

	public LoginGestureListener (android.content.Context p0, android.app.Activity p1)
	{
		super ();
		if (getClass () == LoginGestureListener.class)
			mono.android.TypeManager.Activate ("TheiaBProjectv2.Listeners.LoginGestureListener, TheiaBProjectv2", "Android.Content.Context, Mono.Android:Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
